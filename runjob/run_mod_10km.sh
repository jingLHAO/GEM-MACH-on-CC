...
#SBATCH --job-name="run_mod"     # job name
...
. ./.common_setup intel
. /$MY_DEFAULT_PATH/scripts/runmod.sh -dircfg $MY_DEFAULT_PATH/work-AlmaLinux-9.3-x86_64-intel-2021.10.0/configurations/os_v524_machOSrun5 -ptopo 37x46x1 -inorder